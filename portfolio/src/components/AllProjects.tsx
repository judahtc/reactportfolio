    ...
    return (
        <>
            <div className="relative top-5">
                <>
                    <div
                        className="lg:mx-28 md:mx-28  text-gray-700 mx-0  overflow-hidden"
                        id="one"
                    >
                        <div>
                                    ...
                                    <div className="bg-gray-50 -mt-2">
                                        <div className="mt-2 p-2 mx-2 ">
                                            ...
                                            <div className="summary">
                                                <p>
                                                    The Patients Visits Manager
                                                    is a system designed to
                                                    verify and manage authorized
                                                    visitors for patients. The
                                                    system is by Admins and
                                                    Security personnel, with
                                                    patients also able to log in
                                                    and proactively authorize
                                                    visitors. Security can
                                                    verify the visitor’s
                                                    identity using their
                                                    National ID and check
                                            ...
                                            <div className="mt-2 p-2 mx-2 ">
                                                ...
                                                <div className="summary">
                                                    <p>
                                                        ...
                                                        allows Gated communities
                                                        to book gate entry
                                                        access for their
                                                        visitors. A resident has
                                                        access to create a
                                                        booking for a visitor, a
                                                        visitor then recieves a
                                                        QR Code that will be
                                                        presented to the
                                                        residential gate
                                                        security for
                                                        authentication. If
                                                        Authenticated, the
                                                        security will then give
                                                        entry access to the
                                                        visitor whether
                                                        automatically or
                                                        manually.
                                    ...
                                    <div className=" border border-gray-100 rounded-lg lg:mx-0 md:mx-0 mx-8">
                                        ...
                                        <div className="bg-gray-50 -mt-2">
                                            <div className="mt-2 p-2 mx-2 ">
                                                ...
                                                <div className="summary">
                                                    <p>
                                                        Financials Automator is
                                                        a system designed to
                                                        easy the work of finance
                                                        and accounting
                                                        personale, by actively
                                                        reading data from their
                                                        administrative systems
                                                        and create reports as
                                                        well as financial
                                                        statements, including
                                                        and not limited to the
                                                        Balance Sheet, Trial
                                                        Balance, Income
                                                        Statement and the Profit
                                                        and Loss. It is a SAAS
                                                        that is accessible
                                                        securely on AWS Cloud
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
