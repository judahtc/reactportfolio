    ...
    return (
        <>
            <div className="lg:flex lg:justify-center lg:items-center">
                <div className=" lg:mx-auto lg:w-[70%] lg:mt-20 md:mx-auto md:mt-20   md:ml-10  mt-20">
                    <div className=""></div>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-x-9 gap-2 items-start mt-10 gap-y-9 mx-4  md:mx-0">
                        <div className="cert border hover:bg-gray-50 border-gray-200 rounded-md px-4 py-3 flex items-center space-x-2 lg:w-[98%]  w-full  relative">
        ...
        `}
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/3c43d1bf-a2ce-4a6b-bda7-66b9b567cfad"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
        ...
        `}
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/1b9e5b16-4fea-4c38-b600-ff4be49c8cc1"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
...
`}
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/0d759fe8-7454-4ed3-b06c-5257267ce4ac"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="cert border hover:bg-gray-50 border-gray-200 rounded-md px-4 py-3 flex items-center space-x-2 lg:w-[98%]  w-full relative">
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/d677095e-0afb-4e5c-94e0-aff75029560a"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
