...
export default function About() {
    ...
    return (
        <>
            <div
                className="ml-52 mr-20 mt-24 w-1/2 opacity-0 transform translate-y-10" // Added opacity and translation
                id="animatedText"
                style={localstyle}
            >
                ...
                <div className="lg:w-11/12 lg:ml-3 lg:mb-3 text-md text-gray-700">
                    <p className="mb-3">
